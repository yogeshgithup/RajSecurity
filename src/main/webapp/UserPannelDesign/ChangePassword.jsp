...
<%
    String email=null;
        if(session.getAttribute("email")==null && session.getAttribute("client")==null)
        response.sendRedirect(application.getContextPath()+"/UserPannelDesign");
        if(session.getAttribute("email")!=null && session.getAttribute("client")==null)
         email=(String)session.getAttribute("email");
        if(session.getAttribute("email")==null && session.getAttribute("client")!=null)
         email=(String)session.getAttribute("client");
    %>
<body class="bg-dark">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    ...
                    <h3 style="color: #cccccc">RajSecurityForce</h3>
                </div>
                <div class="login-form">
                    <form action="<%= application.getContextPath() %>/ChangePass" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="confirm" class="form-control" placeholder="Comfirm New Password" required="">
                        </div>
