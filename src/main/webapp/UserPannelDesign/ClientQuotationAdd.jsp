  ...
  <link href="<%=application.getContextPath()%>/UserPannelDesign/files/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <script>
        ...
        "deferRender": true,
         ...
         "sort":false,
         "language": {
      "emptyTable": "No Pending Quotation Request From This Client"
    },
         "paging": false,
                               "ajax": '<%=application.getContextPath()%>/viewClientQuotation?id='+$('#clientpicker').val(),
                    ...
                    $('#submit').on('click',function(e){
                       ...
                       json = json + "]";
                       if(json!=="]")
                       location.href='<%=application.getContextPath()%>/AddQuotationServlet?re='+json+'&type=client';
                       else
