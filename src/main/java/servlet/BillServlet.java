    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(c!=null)
            {
                ...
                System.out.println(client+" "+billno+" "+mon+" "+m+" "+year);
                ...
                for(int i=0;i<cq.size();i++)
                {
                   ...
                   ClientQuotation cc = cq.get(i);
                    System.out.println();
                    System.out.println("slkdjjepod : "+cc.getRate());
                    System.out.println("alksdlsdlsdk : "+bo.getFinal1(client, m, year,cc.getRate()+""));
               ...
               System.out.println("gst = "+gst);
                ...
                int igtotal = (int)Math.round(gtotal);
                ...
                bd = new BillDetails(billno,bo.getClient(client) ,dd,address,total+"" , gg[0]+"", gg[0]+"", "0", igtotal+"",word,aa+"",gstt,ggg);
                bo.delBillAll();
                ...
                for(int i=0;i<cq.size();i++)
                {
                    ...
                    bb=new BillAllDetails(srno+"", particulars, qty+"", str, pp[0]+"", billno, srno+"",ppp+"");
